;(function(A, e) {
  ...
  return (function(A) {
    ...
    '23e7': function(A, e, t) {
      ...
      A.exports = function(A, e) {
        var t,
          ...
          h = A.global,
          v = A.stat
        if (((u = h ? n : v ? n[g] || a(g, {}) : (n[g] || {}).prototype), u))
          for (s in e) {
            if (
              ((l = e[s]),
              A.noTargetGet ? ((p = r(u, s)), (d = p && p.value)) : (d = u[s]),
              (t = f(h ? s : g + (v ? '.' : '#') + s, A.forced)),
              !t && void 0 !== d)
            ) {
    ...
    '499e': function(A, e, t) {
      ...
      function n(A, e) {
        for (var t = [], n = {}, r = 0; r < e.length; r++) {
          var o = e[r],
            ...
            c = o[2],
            f = o[3],
            u = { id: A + ':' + r, css: a, media: c, sourceMap: f }
      ...
      function g(A) {
        for (var e = 0; e < A.length; e++) {
          ...
          if (n) {
            ...
            var i = []
            for (r = 0; r < t.parts.length; r++) i.push(v(t.parts[r]))
      ...
      function B(A, e, t, n) {
        var r = t ? '' : n.css
        if (A.styleSheet) A.styleSheet.cssText = E(e, r)
        else {
        ...
        i = function(A) {
          return function(e, t, i) {
            var a,
              ...
              u = o(i, f)
            if (A && t != t) {
              while (f > u) if (((a = c[u++]), a != a)) return !0
            } else for (; f > u; u++) if ((A || u in c) && c[u] === t) return A || u || 0
            return !A && -1
          }
        }
    ...
    '60ae': function(A, e, t) {
      ...
      f
        ...
        : i &&
          ((n = i.match(/Edge\/(\d+)/)),
          (!n || n[1] >= 74) && ((n = i.match(/Chrome\/(\d+)/)), n && (r = n[1]))),
        (A.exports = r && +r)
    },
    '62a3': function(A, e) {
      A.exports =
    ...
    '65f0': function(A, e, t) {
      ...
      A.exports = function(A, e) {
        ...
        return (
          r(A) &&
            ((t = A.constructor),
            'function' != typeof t || (t !== Array && !r(t.prototype))
    ...
    '69f3': function(A, e, t) {
      ...
      A.exports = { set: n, get: r, has: o, enforce: p, getterFor: g }
    },
    '6cbe': function(A, e, t) {
    ...
    '6eeb': function(A, e, t) {
      ...
      ;(A.exports = function(A, e, t, a) {
        var c = !!a && !!a.unsafe,
          ...
          d = !!a && !!a.noTargetGet
        'function' == typeof t &&
          ('string' != typeof e || o(t, 'name') || r(t, 'name', e),
          (u(t).source = s.join('string' == typeof e ? e : ''))),
          A !== n
            ? (c ? !d && A[e] && (f = !0) : delete A[e], f ? (A[e] = t) : r(A, e, t))
            : f
            ? (A[e] = t)
            : i(e, t)
      ...
      ;(a[g] = !0),
        (A.exports =
          ...
          function(A, e) {
            var t
            return (
              null !== A ? ((h[l] = r(A)), (t = new h()), (h[l] = null), (t[g] = A)) : (t = b()),
              void 0 === e ? t : o(t, e)
            )
          })
    },
    ...
    '83af': function(A, e, t) {
      ...
      var r = function(A, e, t) {
        ...
        i = function A(e) {
          var t = {}
          for (var n in e) 'children' !== n && 'parent' !== n && (t[n] = e[n])
          if (e.children && e.children.length > 0) {
            t.children = []
            for (var r = 0, o = e.children.length; r < o; r++) t.children.push(A(e.children[r]))
          }
          return t
        }
    },
    ...
    '91a9': function(A, e, t) {
      ...
      r('65bc41e4', n, !0, { sourceMap: !1, shadowMode: !1 })
    },
    '94ca': function(A, e, t) {
      var n = t('d039'),
        r = /#|\.prototype\./,
          ...
          concat: function(A) {
            ...
            for (e = -1, n = arguments.length; e < n; e++)
              if (((o = -1 === e ? i : arguments[e]), B(o))) {
                ...
                for (t = 0; t < r; t++, d++) t in o && f(s, d, o[t])
              } else {
          ...
          splice: function(A, e) {
            ...
            if (
              (0 === m
                ...
                : 1 === m
                ? ((t = 0), (n = B - b))
                : ((t = m - 2), (n = d(s(o(e), 0), B - b))),
              B + t - n > l)
            )
              throw TypeError(p)
            for (u = c(E, n), g = 0; g < n; g++) (h = b + g), h in E && f(u, g, E[h])
            if (((u.length = n), t < n)) {
              for (g = b; g < B - n; g++)
                (h = g + n), (v = g + t), h in E ? (E[v] = E[h]) : delete E[v]
              for (g = B; g > B - n + t; g--) delete E[g - 1]
            } else if (t > n)
              for (g = B - n; g > b; g--)
                (h = g + n - 1), (v = g + t - 1), h in E ? (E[v] = E[h]) : delete E[v]
            for (g = 0; g < t; g++) E[g + b] = arguments[g + 2]
    ...
    a4d3: function(A, e, t) {
      ...
      var n = t('23e7'),
        ...
        iA = function(A, e) {
          var t = ($[A] = B(z[P]))
          return H(t, { type: L, tag: A, description: e }), a || (t.description = e), t
        },
        aA = f
          ? function(A) {
        ...
        cA = function(A, e, t) {
          ...
          return (
            ...
            s($, n)
              ? (t.enumerable
                  ? (s(A, F) && A[F][n] && (A[F][n] = !1), (t = B(t, { enumerable: E(0, !1) })))
                  : (s(A, F) || Z(A, F, E(1, {})), (A[F][n] = !0)),
                oA(A, n, t))
              : Z(A, n, t)
          )
        },
        ...
        sA = function(A) {
          ...
          return (
            !(this === V && s($, e) && !s(q, e)) &&
            (!(t || !s(this, e) || !s($, e) || (s(this, F) && this[F][e])) || t)
          )
        },
        dA = function(A, e) {
          var t = h(A),
      ...
      if (
        (c ||
          ((z = function() {
            ...
            return a && rA && oA(V, e, { configurable: !0, set: t }), iA(e, A)
          }),
          M(z[P], 'toString', function() {
            return J(this).tag
          }),
          M(z, 'withoutSetter', function(A) {
            return iA(j(A), A)
          }),
          (D.f = sA),
          (I.f = cA),
          ...
          a &&
            ...
            i || M(V, 'propertyIsEnumerable', sA, { unsafe: !0 }))),
        n({ global: !0, wrap: !0, forced: !c, sham: !c }, { Symbol: z }),
        U(b(tA), function(A) {
          O(A)
        }),
        n(
          { target: L, stat: !0, forced: !c },
          {
            for: function(A) {
              var e = String(A)
        ...
        n(
          ...
          { create: uA, defineProperty: cA, defineProperties: fA, getOwnPropertyDescriptor: dA }
        ),
        n(
          { target: 'Object', stat: !0, forced: !c },
          { getOwnPropertyNames: lA, getOwnPropertySymbols: pA }
        ),
        n(
          {
            target: 'Object',
        ...
        var gA =
          ...
          u(function() {
            var A = z()
            return '[null]' != _([A]) || '{}' != _({ a: A }) || '{}' != _(Object(A))
          })
        n(
          { target: 'JSON', stat: !0, forced: gA },
          {
            stringify: function(A, e, t) {
              ...
              if (((n = e), (l(e) || void 0 !== A) && !aA(A)))
                return (
                  d(e) ||
                    (e = function(A, e) {
                      if (('function' == typeof n && (e = n.call(this, A, e)), !aA(e))) return e
                    }),
                  (r[1] = e),
                  _.apply(null, r)
                )
      ...
      z[P][k] || N(z[P], k, z[P].valueOf), Y(z, L), (S[F] = !0)
    },
    a691: function(A, e) {
      var t = Math.ceil,
        n = Math.floor
    ...
    a76f: function(A, e, t) {
      ...
      var a = (function() {
          function A(e) {
            ...
            var t = e.id,
              r = e.isLeaf
            for (var o in ((this.id = 'undefined' === typeof t ? new Date().valueOf() : t),
            (this.parent = null),
            (this.children = null),
            (this.isLeaf = !!r),
            e))
              'id' !== o && 'children' !== o && 'isLeaf' !== o && (this[o] = e[o])
          }
          return (
            o(A, [
              {
              ...
              },
              {
                ...
                value: function(A) {
                  'root' !== this.name &&
                    this !== A &&
                    (this.isTargetChild(A) ||
                      A.isLeaf ||
                      (this.parent._removeChild(this),
                      (this.parent = A),
                      (this.pid = A.id),
                      A.children || (A.children = []),
                      A.children.unshift(this)))
                }
              },
              {
                key: 'findChildIndex',
        ...
        c = (function() {
          function A(e) {
            return (
              n(this, A),
              (this.root = new a({ name: 'root', isLeaf: !1, id: 0 })),
              this.initNode(this.root, e),
              this.root
            )
          }
          return (
            o(A, [
              {
                ...
                value: function(A, e) {
                  for (var t = 0, n = e.length; t < n; t++) {
                    var r = e[t],
                      o = new a(r)
                    r.children && r.children.length > 0 && this.initNode(o, r.children),
                      A.addChildren(o)
                  }
                }
              }
    ...
    b2b9: function(A, e, t) {
      ...
      var n = function() {
          var A = this,
            e = A.$createElement,
            t = A._self._c || e
          return t('div', { staticClass: 'vtl' }, [
            'root' !== A.model.name
              ? t(
                  'div',
                  {
                    staticClass: 'vtl-node',
                    class: { 'vtl-leaf-node': A.model.isLeaf, 'vtl-tree-node': !A.model.isLeaf },
                    attrs: { id: A.model.id }
                  },
                  [
                    t('div', {
                      staticClass: 'vtl-border vtl-up',
                      class: { 'vtl-active': A.isDragEnterUp },
                      on: {
                        drop: A.dropBefore,
                    ...
                    t(
                      'div',
                      {
                        ...
                        attrs: { draggable: !A.model.dragDisabled },
                        on: {
                          ...
                          dblclick: function(e) {
                            return e.stopPropagation(), A.dbclick(e)
                          }
                        }
                      },
                      [
                        A.model.children && A.model.children.length > 0
                          ? t('span', { staticClass: 'vtl-caret vtl-is-small' }, [
                              t('i', {
                        ...
                        A.model.isLeaf
                          ? t(
                              ...
                              [
                                A._t(
                                  'leafNodeIcon',
                                  [t('i', { staticClass: 'vtl-icon vtl-menu-icon vtl-icon-file' })],
                                  { expanded: A.expanded, model: A.model, root: A.rootNode }
                                )
                              ],
                              2
                            )
                        ...
                        A.editable
                          ? t('input', {
                              ...
                              attrs: { type: 'text' },
                              domProps: { value: A.model.name },
                              on: { input: A.updateName, blur: A.setUnEditable }
                            })
                          : t(
                              'div',
                        ...
                        t(
                          ...
                          [
                            A.model.isLeaf || A.model.addTreeNodeDisabled
                              ? A._e()
                              : t(
                                  'span',
                                  {
                                    attrs: { title: A.defaultAddTreeNodeTitle },
                                    on: {
                                      click: function(e) {
                                        return (
                                  ...
                                  [
                                    A._t(
                                      'addTreeNodeIcon',
                                      [t('i', { staticClass: 'vtl-icon vtl-icon-folder-plus-e' })],
                                      { expanded: A.expanded, model: A.model, root: A.rootNode }
                                    )
                                  ],
                                  2
                                ),
                            A.model.isLeaf || A.model.addLeafNodeDisabled
                              ? A._e()
                              : t(
                                  'span',
                                  {
                                    attrs: { title: A.defaultAddLeafNodeTitle },
                                    on: {
                                      click: function(e) {
                                        return (
                                  ...
                                  [
                                    A._t(
                                      'addLeafNodeIcon',
                                      [t('i', { staticClass: 'vtl-icon vtl-icon-plus' })],
                                      { expanded: A.expanded, model: A.model, root: A.rootNode }
                                    )
                                  ],
                                  2
                                ),
                            A.model.editNodeDisabled
                              ? A._e()
                              : t(
                                  'span',
                                  {
                                  ...
                                  [
                                    A._t(
                                      'editNodeIcon',
                                      [t('i', { staticClass: 'vtl-icon vtl-icon-edit' })],
                                      { expanded: A.expanded, model: A.model, root: A.rootNode }
                                    )
                                  ],
                                  2
                                ),
                            A.model.delNodeDisabled
                              ? A._e()
                              : t(
                                  'span',
                                  {
                                  ...
                                  [
                                    A._t(
                                      'delNodeIcon',
                                      [t('i', { staticClass: 'vtl-icon vtl-icon-trash' })],
                                      { expanded: A.expanded, model: A.model, root: A.rootNode }
                                    )
                                  ],
                                  2
                    ...
                    A.model.children && A.model.children.length > 0 && A.expanded
                      ? t('div', {
                          staticClass: 'vtl-border vtl-bottom',
                          class: { 'vtl-active': A.isDragEnterBottom },
                          on: {
                            drop: A.dropAfter,
            ...
            A.isFolder
              ? t(
                  'div',
                  {
                    ...
                    class: { 'vtl-tree-margin': 'root' !== A.model.name }
                  },
      ...
      var u = null,
        s = {
          ...
          props: {
            model: { type: Object },
            defaultLeafNodeName: { type: String, default: 'Leaf Node' },
            defaultTreeNodeName: { type: String, default: 'Tree Node' },
            defaultAddTreeNodeTitle: { type: String, default: 'Add Tree Node' },
            defaultAddLeafNodeTitle: { type: String, default: 'Add Leaf Node' },
            defaultExpanded: { type: Boolean, default: !0 }
          },
          computed: {
            rootNode: function() {
              var A = this.$parent
              while ('root' !== A._props.model.name) A = A.$parent
              return A
            },
            caretClass: function() {
          ...
          methods: {
            ...
            click: function() {
              this.rootNode.$emit('click', f({ toggle: this.toggle }, this.model))
            },
            dbclick: function() {
            ...
            addChild: function(A) {
              ...
              this.expanded = !0
              var t = new i['b']({ name: e, isLeaf: A })
              this.model.addChildren(t, !0), this.rootNode.$emit('add-node', t)
            },
            dragStart: function(A) {
              return (
                !this.model.dragDisabled &&
                !this.model.disabled &&
                ((u = this),
                A.dataTransfer.setData('data', 'data'),
            ...
            dragEnter: function() {
              u &&
                u.model.id !== this.model.id &&
                u &&
                !this.model.isLeaf &&
                (this.isDragEnterNode = !0)
            },
            dragLeave: function() {
            ...
            drop: function() {
              if (u) {
                ...
                u.model.moveInto(this.model),
                  (this.isDragEnterNode = !1),
                  this.rootNode.$emit('drop', { target: this.model, node: u.model, src: A })
              }
            },
            ...
            dropBefore: function() {
              if (u) {
                var A = u.model.parent
                u.model.insertBefore(this.model),
                  (this.isDragEnterUp = !1),
                  this.rootNode.$emit('drop-before', { target: this.model, node: u.model, src: A })
              }
            },
            ...
            dropAfter: function() {
              if (u) {
                var A = u.model.parent
                u.model.insertAfter(this.model),
                  (this.isDragEnterBottom = !1),
                  this.rootNode.$emit('drop-after', { target: this.model, node: u.model, src: A })
              }
            }
          }
        },
      ...
      function l(A, e, t, n, r, o, i, a) {
        ...
        if (
          (e && ((f.render = e), (f.staticRenderFns = t), (f._compiled = !0)),
          n && (f.functional = !0),
          ...
          return function(l, p, g, h) {
            for (
              var v,
                ...
                y = 0,
                Q = h || a,
                I = e ? Q(l, w) : t ? Q(l, 0) : void 0;
              w > y;
              y++
            )
              if ((d || y in b) && ((v = b[y]), (E = m(v, y, B)), A))
                if (e) I[y] = E
                else if (E)
                  switch (A) {
                    case 3:
    ...
    ca84: function(A, e, t) {
      ...
      A.exports = function(A, e) {
        var t,
          ...
          c = 0,
          f = []
        for (t in a) !n(i, t) && n(a, t) && f.push(t)
        while (e.length > c) n(a, (t = e[c++])) && (~o(f, t) || f.push(t))
        return f
      }
    },
    cc12: function(A, e, t) {
    ...
    d44e: function(A, e, t) {
      var n = t('9bf2').f,
        ...
        i = o('toStringTag')
      A.exports = function(A, e, t) {
        A && !r((A = t ? A : A.prototype), i) && n(A, i, { configurable: !0, value: e })
      }
    },
    da84: function(A, e, t) {
      ;(function(e) {
        ...
        { target: 'Object', stat: !0, sham: !r },
        {
          getOwnPropertyDescriptors: function(A) {
            var e,
              ...
              u = {},
              s = 0
            while (f.length > s) (t = r(n, (e = f[s++]))), void 0 !== t && c(u, e, t)
            return u
          }
        }
      )
          ...
          Object.defineProperty(A, e, {
            get: function() {
              try {
                ...
                for (A in t) if (t[A].src == e || 'interactive' == t[A].readyState) return t[A]
                return null
              }
            }
          })
